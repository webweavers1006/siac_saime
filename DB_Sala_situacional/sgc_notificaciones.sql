...
COMMENT ON COLUMN public.sgc_notificaciones.leida INDICA si la notificación ha sido leída';
...
-- VALUES (123, 'REMISION', 'Se le ha remitido el caso #123 de: Juan Pérez a su dirección (Dirección de Atención)', 5, 25);
