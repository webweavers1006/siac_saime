...
function listar_usuarios_areas() {
    $('#table_usuarios_areas').DataTable({
        ...
        //"stateSave": true,
        "ajax": {
            "url": "https://siac.sapi.gob.ve/api/audiencia/usuarios_areas", // URL correcta
            "type": "GET",
            headers: {
...
$(document).on('submit', "#new-usuario-area", function(e) {
    ...
    if (id_usuario == 0 || id_usuario == '0' || id_usuario == null) {
        ...
        $.ajax({
            type: "POST",
            url: "https://siac.sapi.gob.ve/api/audiencia/usuarios_areas",
...
function llenar_usuarios(e, id_usuario) {
    ...
    $.ajax({
        type: "GET",
        url: "https://siac.sapi.gob.ve/api/audiencia/usuarios/1/1000",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        headers: {
            'Authorization': `Bearer ${user_audiencia.token}` // Agregar token aquí
...
$(document).on('submit', "#edit-usuarios_areas", function(e) {
    ...
    if (id_usuario == 0 || id_usuario == '0' || id_usuario == null) {
        ...
        $.ajax({
            type: "PUT",
            url: "https://siac.sapi.gob.ve/api/audiencia/usuarios_areas/"+id_usuario_area,
            data: JSON.stringify(datos_audiencia),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            headers: {
