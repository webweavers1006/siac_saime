...
function listar_reportes(desde = null, hasta = null, tipo_pi = null, tipo_atencion_usu = null, sexo = null, via_atencion = null, direcciones_caso = null, tipo_beneficiario = 0,atencion_cuidadano = 0,estatus=0,id_estado=0,id_municipio=0,id_parroquia=0,edad_min=null,edad_max=null,detalle_atencion=0,nombre_propiedad, nombre_atencion, nombresexo, nombre_via_atencion, nombre_tipo_beneficiario, nombre_direccion_remi,nombre_aten_cuidadano,nombre_estatus=null,nombre_estado=null) {
    ...
    var table = $('#table_participantes').DataTable({
        ...
        "ajax": {
            "url": "/listar_talleres_participantes/" + desde + '/' + hasta + '/' + tipo_pi + '/' + tipo_atencion_usu + '/' + sexo + '/' + via_atencion + '/' + direcciones_caso + '/' + tipo_beneficiario+ '/' +atencion_cuidadano+'/'+estatus+'/'+id_estado+'/'+id_municipio+'/'+id_parroquia+'/'+edad_min+'/'+edad_max+'/'+detalle_atencion,
            "type": "GET",
            dataSrc: ''
        },
        "columns": [
