...
<div class="content-wrapper">
  ...
  <div class="content">
    <div class="container">
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="d-flex justify-content-between">
                <h3 class="text-secondary"><i class="fas fa-angle-double-right"></i>Tipo de Beneficiarios
                  <button type="submit" id="btn_agregar" class="btn btn-sm btn-primary btn_agregar" data-toggle="modal" data-target="#add-tipo-beneficiario">Agregar</button>
                </h3>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-11 col-sm-11 col-md-11 ">
                    <div class="card">
                      <div class="card-body">
                        <table class="display table-responsive" id="table_beneficiarios" style="width:100%" style="margin-top: 20px">
                          <thead>
                            <tr>
                          ...
                          <tbody id="listar_tipo_Beneficiarios">
                          </tbody>
                        </table>
                      </div>
                    </div>
      ...
      <div class="modal fade" id="add-tipo-beneficiario">
        <div class="modal-dialog modal-dialog-centered  modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Tipo de Beneficiarios</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form id="new-beneficiarios" method="POST" role="form">
      ...
      <div class="modal fade" id="editar">
        <div class="modal-dialog modal-dialog-centered  modal-md">
          <div class="modal-content">
            ...
            <form id="edit-beneficiairos" method="POST" role="form">
              <div class="modal-body">
                <div class="form-group">
                  <label for="user-name">Nombre</label>
                  <input type="hidden" name="id-beneficiario" id="id-beneficiario" class="form-control">
                  <input type="text" name="name-beneficiario" id="editar-beneficiario" class="form-control"  autocomplete="off" required>
                </div>
