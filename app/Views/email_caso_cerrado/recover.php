...
<head>
  ...
  <meta charset="utf-8">
  <meta lang="es">
  <title>Intranet SAPI - Caso Cerrado</title>
  <style type="text/css">
body {
  background-color: #fafbfc; /* Color de fondo del cuerpo */
  padding: 0 !important;
  margin: 0 !important;
  width: 100% !important;
...
<body style="background-color: #fafbfc;">
  <table class="MainContainer" bgcolor="#ffffff" width="100%" border="0" cellspacing="0" cellpadding="0" class="tableContent" align="center" style="font-family:Helvetica, Arial,serif;">
    <tbody>
      <tr>
        <td>
                                     ...
                                     <tr>
                                       <td valign="top" align="center">
                                         ...
                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                           ...
                                           <img src="<?= base_url('img/logo_sapi_2020.png') ?>" width="120" height="80" alt="Logo del SAPI" data-default="placeholder" data-max-width="560">
                                            
                                            </td>
                                            <td>
                                            <img src="<?= base_url('img/LogoSIAC_sapi2.png') ?>" width="120" height="80" alt="Logo del SAPI" data-default="placeholder" data-max-width="560">
                                           </td>
                                         </table>
