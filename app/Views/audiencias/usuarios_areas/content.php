...
<div class="content-wrapper">
  ...
  <div class="content">
    <div class="container">
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="d-flex justify-content-between">
                <h3 class="text-secondary"><i class="fas fa-angle-double-right"></i>Usuarios Areas
                  <button type="submit" id="btn_agregar" class="btn btn-sm btn-primary btn_agregar" data-toggle="modal" data-target="#add-usuarios_areas">Agregar</button>
                </h3>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-11 col-sm-11 col-md-11 ">
                    <div class="card">
                      <div class="card-body">
                        <table class="display table-responsive" id="table_usuarios_areas" style="width:100%" style="margin-top: 20px">
                          <thead>
                            <tr>
                              <td class="text-center" style="width: 1%;">id</td>
                              <td class="text-center" style="width: 20%;">Nombre</td>
                              <td class="text-center" style="width: 20%;">Area</td>
                              <td class="text-center" style="width: 1%;">Acciones</td>
                            </tr>
                          </thead>
                          <tbody id="listar_usuario_areas">
                          </tbody>
                        </table>
                      </div>
                    </div>
      ...
      <div class="modal fade" id="add-usuarios_areas">
        <div class="modal-dialog  modal-dialog-centered  modal-md">
          <div class="modal-content">
            ...
            <form id="new-usuario-area" method="POST" role="form">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="user-name">Director</label>
      ...
      <div class="modal fade" id="editar">
        <div class="modal-dialog  modal-dialog-centered modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Editar Usuario Area </h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form id="edit-usuarios_areas" method="POST" role="form">
              <div class="modal-body">
                <div class="form-group">
                  <label for="user-name">Nombre</label>
                  <input type="hidden" name="id_usuario_area" id="id_usuario_area" class="form-control">
                </div>

                <div class="form-group">
                  <label for="user-name">Usuario</label>
                  <select name="id_usuario" id="edit_id_usuario">
                          <option value="0" selected>---Seleccione un Usuario---</option>
                  </select>
                </div>
                ...
                <div class="form-group">
                  <label for="user-name">Area</label>
                  <select name="id_departamento" id="edit_id_area" aria-label="Seleccione un Área">
                ...
                <div class="form-group">
                  <label for="user-name">Director</label>
                  <select name="id_departamento" id="edit_id_director">
