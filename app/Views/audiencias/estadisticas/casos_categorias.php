...
// Loop through the $casos array and extract the category names and totals
<?php foreach ($casos['solicitudesbyCategorias'] as $categoria) { ?>
  labels.push('<?php echo $categoria["categoria"]; ?>');
  data.datasets[0].data.push(<?php echo $categoria["total"]; ?>);
<?php } ?>
