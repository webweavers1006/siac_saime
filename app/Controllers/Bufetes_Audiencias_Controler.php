...
class Bufetes_Audiencias_Controler extends BaseController
{
	use ResponseTrait;

	//Metodo que muestra la vista de las direcciones 
	public function vista_Bufetes_audiencias()
	{
		if ($this->session->get('logged')) {
			echo view('template/header');
			echo view('template/nav_bar');
			echo view('audiencias/bufetes/content.php');
			echo view('template/footer');
			echo view('audiencias/bufetes/footer_bufetes.php');
		} else {
			return redirect()->to('/');
		}
	}
