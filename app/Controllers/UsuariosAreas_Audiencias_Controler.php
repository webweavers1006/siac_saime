...
class UsuariosAreas_Audiencias_Controler extends BaseController
{
	use ResponseTrait;

	//Metodo que muestra la vista de las direcciones 
	public function vista_Usuario_Areas_audiencias()
	{
		if ($this->session->get('logged')) {
			echo view('template/header');
			echo view('template/nav_bar');
			echo view('audiencias/usuarios_areas/content.php');
			echo view('template/footer');
			echo view('audiencias/usuarios_areas/footer_usuarios_areas.php');
		} else {
			return redirect()->to('/');
		}
	}
