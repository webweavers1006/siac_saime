...
class Roles_Audiencias_Controler extends BaseController
{
	use ResponseTrait;

	//Metodo que muestra la vista de las direcciones 
	public function vista_Roles_audiencias()
	{
		if ($this->session->get('logged')) {
			echo view('template/header');
			echo view('template/nav_bar');
			echo view('audiencias/roles_audiencias/content.php');
			echo view('template/footer');
			echo view('audiencias/roles_audiencias/footer_roles.php');
		} else {
			return redirect()->to('/');
		}
	}
